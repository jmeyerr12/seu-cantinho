...
import { listSpaces, createSpace, getSpace, updateSpace, activateSpace, deleteSpace, listPhotos, addPhoto, deletePhoto, checkAvailability, searchSpaces, viewPhotoImage, listPhotoLinks } from "../controllers/spaces";
...
router.get('/spaces/:id/photos/links', listPhotoLinks);
